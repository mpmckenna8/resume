This Resume was made at first as part of a Udacity JavaScript design patterns Course, but has been hacked up and changed a bit.  I don't think they even offer the course anymore and hopefully teach some libraries besides jquery which in this project can pretty easilly be replaced by native JS which I should work on.  But for now the jquery at least still works perfect in the browsers I use.

But there are a few things I didn't like about the project, like the many useless anchor links.
